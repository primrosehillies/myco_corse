...
invent <- read.csv(file = "inventory4.csv", header = T, stringsAsFactors = T)
...
#4. Réseau bipartite ##4.1 Tous sites confondus
...
for (i in 1:nrow(from_category_s15)) {
  ...
  if (category == "Pioneer species") {
    colors_s15[node] <- "#ffca22ff"
  } else if (category == "End of succession") {
    colors_s15[node] <- "lightblue" 
  } else if (category == "Castanea sativa") {
    colors_s15[node] <- "chartreuse4" 
  }
}
